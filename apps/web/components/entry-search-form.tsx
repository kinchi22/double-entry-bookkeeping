 ...
 *
 * A plain `GET` form, with no action of its own: submitting it puts the
 * criteria in the URL's query, which is what makes a search reloadable,
 * bookmarkable and walkable with the back button, and what the page reads them
 * out of. A search is a read, so nothing here goes near the write path.
 *

...
This is the Implementer's brief. `docs/agents/harnesses.md` defines the words
used here -- Driver, Implementer, Subagent, Skill -- and maps each to the
mechanism your harness gives you.
